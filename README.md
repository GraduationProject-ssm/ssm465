...
# ssm465软件开发团队管理网站+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=63)
...
该软件开发团队管理网站所使用的就是MYSQL数据库，当初是微软公司开发出的MYSQL数据库。MYSQL数据库总共建立了十几个相对应的表，它们之间独立联系，数据库和程序是密不可分的[21]。
...
图2-1 B/S模式架构图
1. ## SSM框架技术
该软件开发团队管理网站是基于Spring、SpringMVC、Mybatis框架开发出来的。
...
1. ## 系统性能分析
1. 存储性：该软件开发团队管理网站的数据库功能比较强大，能够录入很多纷繁复杂的信息，且能够保证数据的实时性；
...
1. # 系统设计
   1. ## 系统概要设计
本文通过B/S结构(Browser/Server,浏览器/服务器结构)开发的该软件开发团队管理网站，B/S结构的优点很多，例如：开发容易、强的共享性、便于维护等，只要有网络，用户可以随时随地进行使用。
...
管理员功能模块和用户功能模块是该软件开发团队管理网站的两大部分，系统结构如图4-2所示。
...
![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\论坛.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\论坛.jpg")
图4.1 论坛实体属性图

（2）下图是学生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\学生.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\学生.jpg")
图4.2 学生实体属性图

（3）下图是教师实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\教师.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\教师.jpg")
图4.3 教师实体属性图

（4）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\公告信息.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\公告信息.jpg")
图4.4 公告信息实体属性图

（5）下图是作品集实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\作品集.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\作品集.jpg")
图4.5 作品集实体属性图

（6）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\字典表.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\字典表.jpg")
图4.6 字典表实体属性图

（7）下图是团队信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\团队信息.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\团队信息.jpg")
图4.7 团队信息实体属性图

（8）下图是团队成员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\团队成员.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\团队成员.jpg")
图4.8 团队成员实体属性图

（9）下图是线上课程实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\线上课程.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\线上课程.jpg")
图4.9 线上课程实体属性图

（10）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\用户表.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\ruanjiankaifatuandui\用户表.jpg")
图4.10 用户表实体属性图
1. ### 数据库表设计
...
|3|tuandui\_types|Integer|团队类型|是|
|4|tuandui\_photo|String|团队封面|是|
|5|tuandui\_zuzhi|String|组织结构|是|
|6|tuandui\_file|String|附件|是|
|7|tuandui\_text|String|加入我们|是|
|8|tuandui\_content|String|团队介绍|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|tuandui\_id|Integer|团队|是|
|3|tuanduichengyuan\_name|String|成员名称|是|
|4|tuanduichengyuan\_photo|String|头像|是|
|5|tuanduichengyuan\_types|Integer|奖项类型|是|
|6|tuanduichengyuan\_zhidaojiaoshi|String|指导教师|是|
|7|tuanduichengyuan\_chengyuan|String|获得奖项|是|
|8|tuanduichengyuan\_xiangmu|String|参加项目|是|
|9|jiuye\_types|Integer|就业情况|是|
|10|tuanduichengyuan\_qiye|String|就业企业|是|
|11|create\_time|Date|创建时间|是|
表4.6线上课程表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xianshangkecheng\_name|String|课程标题|是|
|3|xianshangkecheng\_photo|String|课程封面|是|
|4|xianshangkecheng\_types|Integer|课程类型|是|
|5|xianshangkecheng\_video|String|视频|是|
|6|xianshangkecheng\_text|String|课程详情|是|
|7|create\_time|Date|创建时间|是|
表4.7学生表
...
|1|Id|Int|id|否|
|2|tuandui\_id|Integer|团队|是|
|3|zuopinji\_name|String|作品名称|是|
|4|zuopinji\_photo|String|作品图片|是|
|5|zuopinji\_types|Integer|作品类型|是|
|6|zuopinji\_zhidaojiaoshi|String|指导教师|是|
|7|zuopinji\_chengyuan|String|参加成员|是|
|8|zuopinji\_text|String|详情|是|
|9|create\_time|Date|创建时间|是|
表4.9教师表
...
图5.2 教师信息管理页面
### 5.3团队信息管理
如图5.3显示的就是团队信息管理页面，此页面提供给管理员的功能有：根据团队信息进行条件查询，还可以对团队信息进行新增、修改、查询操作等等。
